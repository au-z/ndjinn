...
describe('Node', () => {
	...
	describe('run', () => {
		...
		let color = Node.create(rgbInc, [0, 0, 0], {immediate: true})
	...
	describe('disconnect', () => {
		let val = num([42])
		let add = Node.create((a, b) => [a + b], [1, 2], {immediate: true})
